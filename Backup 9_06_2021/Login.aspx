...
<head runat="server">
    ...
    <title>Logowanie do Systemu IMGW AWOS Monitor</title>
    <style type="text/css">
        html, body {
	        height: 100%;
               ...
               <asp:Panel ID="div_okno" runat="server" >
                   <div style="height: 300px;position: absolute;top: 70px;width: 100%;z-index: 200;">
                        ...
                        <asp:Panel ID="box" runat="server" style="">
                            <div class="div">Użytkownik jest już zalogowany!</div>
                                <br />
                            <span style="color:Red; font-weight:bold;">

                                <asp:Label ID="lb_box" runat="server" Text="Ostatnie logowanie: "></asp:Label>
                                <br />Czy wymusić wylogowanie osoby?
                            </span>
                            <br /><br />
                            <asp:Button ID="bt_yes" runat="server" CssClass="btn" onclick="btn_OK_Click"  Text="TAK zaloguj mnie" />&nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:Button ID="bt_no" CssClass="btn" onclick="btn_OK_Click"  runat="server" Text="NIE" />
                        </asp:Panel>
                   </div>
               </asp:Panel>
